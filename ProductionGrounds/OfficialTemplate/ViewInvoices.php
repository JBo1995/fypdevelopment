                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">See below all Invoices unpaid by customers</p>
                                <br><br><a href=NewInvoce.php>Create New Invoice</a>
        ...
        <tr bgcolor='white'>
           ...
           <strong> <td>Customer ID</td></strong>
            <strong><td>Customer Name</td></strong>
             <strong><td>Amount Due</td></strong>
